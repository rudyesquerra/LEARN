...
//Validation tests for form input 'name'
...
//does not highlight when no error & highlights when there is an error
...
// no help message & shows help message errors validations
